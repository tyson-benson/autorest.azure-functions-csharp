...
try
{
   ...
   npm run coverage-push --prefix node_modules/@microsoft.azure/autorest.testserver -- Azure/autorest.csharp refs/heads/feature/v4 skip $CoverageUser $CoveragePass
}
finally
{
    popd
